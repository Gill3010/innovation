...
const Chatbot = () => {
  ...
  return (
    <>
      ...
      {/* Chatbot Window */}
      <div
        className={`fixed bottom-24 right-6 w-96 h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col transition-all duration-300 z-50 ${
        ...
        <div className="bg-linear-to-r from-blue-600 to-blue-700 text-white p-4 rounded-t-2xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-100">I can help with scientific research</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-200 p-4">
          <div className="flex gap-2">
            <input
              ...
              placeholder="Ask me about research papers, DOIs, scientific topics..."
            ...
            <button
              ...
              className="px-4 py-3 bg-linear-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-md hover:shadow-lg"
            >
